function zc() 
{
fclone copy fc:{$1} fc:{$2} --drive-server-side-across-configs --stats=1s --stats-one-line --checkers=128 --transfers=128 --drive-pacer-min-sleep=1ms --drive-pacer-burst=5000 --check-first
fclone dedupe newest fc:{$2} --drive-server-side-across-configs  --tpslimit 50
